...
export const blogPosts: BlogPost[] = [
  ...
  // ── PLACEHOLDER ENTRIES ────────────────────────────────────────
  {
    ...
    title: 'KnockFree',
    tag: 'Swift',
    excerpt: 'macOS menu bar app that detects physical knocks on Apple Silicon chassis via IOKit HID accelerometer and maps them to configurable actions.',
    date: '2025',
  ...
  },
  {
    ...
    tag: 'AI',
    excerpt: 'Full-stack exoplanet colonization simulator with configurable CPI scoring, OpenRouter AI analysis, 3D planet rendering via React Three Fiber, and live telemetry charts.',
    date: '2025',
  ...
  },
  {
    ...
    title: 'SHRED',
    tag: 'Web',
    excerpt: 'Personal fitness dashboard tracking workouts, cycling, BJJ, sleep, and weight with automatic PR detection, streak tracking, and a weekly review calendar.',
    date: '2026',
    projectSlug: 'shred',
    placeholder: true,
    content: [],
  ...
  {
    slug: 'humantype',
    title: 'Humantype / Typer',
    tag: 'Python',
    excerpt: 'macOS utility that simulates realistic human typing via system keystroke injection — variable WPM, QWERTY-adjacent typos, corrections, and optional Ollama AI drafting.',
    date: '2024',
  ...
  },
  {
    ...
    tag: 'Web',
    excerpt: 'Next.js finance visualization app with pie, bar, and line charts via Recharts — sortable transaction table, Zod-validated API routes, and type-safe data layer.',
    date: '2025',
  ...
  },
  {
    ...
    tag: 'CV',
    excerpt: 'Real-time push-up counter using MediaPipe Pose — tracks elbow angle to count reps with cooldown debouncing and live visual feedback.',
    date: '2023',
  ...
  },
  {
    ...
    tag: 'CV',
    excerpt: 'Controls the computer mouse with hand gestures — index finger moves cursor, pinch clicks, two-finger point right-clicks, thumb position scrolls.',
    date: '2023',
  ...
  {
    slug: 'deca-bot',
    title: 'DECA Answerwrite Bot',
    tag: 'Python',
    excerpt: 'Automation bot that uses PyAutoGUI template matching to navigate and answer DECA online exams — completes 100 questions using visual element detection.',
    date: '2023',
  ...
  },
  {
    ...
    tag: 'Python',
    excerpt: 'Command-line budgeting tool with JSON persistence — add transactions, view spending by category, and analyze income vs. expenses.',
    date: '2022',
